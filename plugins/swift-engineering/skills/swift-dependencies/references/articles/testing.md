...
In the article [LivePreviewTest](live-preview-test.md) you learned how to define a ``TestDependencyKey/testValue``
...
entire body of your test in [`withDependencies`](../extensions/with-dependencies.md) that
