...
(see [OverridingDependencies](overriding-dependencies.md)), then those changes will also be visible to `EditModel`.
...
If you make sure to always use [withDependencies(from:)](../extensions/with-dependencies-from.md)
when constructing child models and controllers you can be sure that changes to dependencies at
any layer of your application will be visible at any layer below it. See [Lifetimes](lifetimes.md) for
